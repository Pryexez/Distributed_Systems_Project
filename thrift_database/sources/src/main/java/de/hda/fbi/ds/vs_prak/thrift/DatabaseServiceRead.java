...
public class DatabaseServiceRead {

  public interface Iface {

    public java.util.List<Sensordata> read() throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void read(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Sensordata>> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public java.util.List<Sensordata> recv_read() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public static class read_call extends org.apache.thrift.async.TAsyncMethodCall<java.util.List<Sensordata>> {
      public read_call(org.apache.thrift.async.AsyncMethodCallback<java.util.List<Sensordata>> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public java.util.List<Sensordata> getResult() throws org.apache.thrift.TException {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class read<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, read_args, java.util.List<Sensordata>> {
      public read() {
        super("read");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<java.util.List<Sensordata>> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<java.util.List<Sensordata>>() { 
          public void onComplete(java.util.List<Sensordata> o) {
            read_result result = new read_result();
            result.success = o;
            try {
      ...
      public void start(I iface, read_args args, org.apache.thrift.async.AsyncMethodCallback<java.util.List<Sensordata>> resultHandler) throws org.apache.thrift.TException {
...
;
  ...
  public static class read_result implements org.apache.thrift.TBase<read_result, read_result._Fields>, java.io.Serializable, Cloneable, Comparable<read_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable java.util.List<Sensordata> success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.FieldValueMetaData(org.apache.thrift.protocol.TType.LIST          , "sensorDataList")));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public read_result(
      java.util.List<Sensordata> success)
    {
      this();
    ...
    public read_result(read_result other) {
      if (other.isSetSuccess()) {
        java.util.List<Sensordata> __this__success = new java.util.ArrayList<Sensordata>(other.success.size());
    ...
    public void addToSuccess(Sensordata elem) {
      if (this.success == null) {
        this.success = new java.util.ArrayList<Sensordata>();
      }
      this.success.add(elem);
    }

    @org.apache.thrift.annotation.Nullable
    public java.util.List<Sensordata> getSuccess() {
      return this.success;
    }

    public read_result setSuccess(@org.apache.thrift.annotation.Nullable java.util.List<Sensordata> success) {
      this.success = success;
      return this;
    }
    ...
    public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
      ...
      case SUCCESS:
        if (value == null) {
          ...
          setSuccess((java.util.List<Sensordata>)value);
        }
        break;
              ...
              if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
                {
                  ...
                  struct.success = new java.util.ArrayList<Sensordata>(_list0.size);
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, read_result struct) throws org.apache.thrift.TException {
        ...
        if (struct.success != null) {
          oprot.writeFieldBegin(SUCCESS_FIELD_DESC);
          {
            ...
            for (Sensordata _iter3 : struct.success)
            {
              _iter3.write(oprot);
            }
            oprot.writeListEnd();
        ...
        if (struct.isSetSuccess()) {
          {
            ...
            for (Sensordata _iter4 : struct.success)
            {
              _iter4.write(oprot);
            }
          }
        ...
        if (incoming.get(0)) {
          {
            ...
            struct.success = new java.util.ArrayList<Sensordata>(_list5.size);
